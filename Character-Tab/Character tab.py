...
def query():
    ...
    query_label = Label(characters_tab, text=print_records)
...
CreateButton = tkinter.Button(characters_tab, text="New Character", bd=0, bg="#4285F4", fg="White", padx=30, pady=10, font="Montserrat", relief=FLAT, command=CreateButton_action)
CreateButton.place(x=25, y=25)

# "Delete Character" button UI
DeleteButton = tkinter.Button(characters_tab, text="Delete Character", bd=0, bg="#4285F4", fg="White", padx=30, pady=10, font="Montserrat", relief=FLAT, command=delete)
DeleteButton.place(x=980, y=25)

# "Edit Character" button UI
Edit_button = tkinter.Button(characters_tab, text="Edit Character", bd=0, bg="#4285F4", fg="White", padx=30, pady=10, font="Montserrat", relief=FLAT, command=edit)
Edit_button.place(x=225, y=25)
